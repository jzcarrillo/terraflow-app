...
router.put('/transfers/:id/status', authenticateToken, requireRole(['ADMIN', 'CASHIER']), transferController.updateTransferStatus);
router.put('/transfers/:id', authenticateToken, requireRole(['ADMIN', 'CASHIER']), transferController.updateTransfer);
