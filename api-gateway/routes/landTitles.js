...
router.get('/land-titles', authenticateToken, requireRole(['ADMIN', 'CASHIER', 'LAND_TITLE_PROCESSOR']), landTitleController.getAllLandTitles);
router.get('/land-titles/validate/:titleNumber', landTitleController.validateTitleNumber);
router.get('/land-titles/:id', authenticateToken, requireRole(['ADMIN', 'CASHIER', 'LAND_TITLE_PROCESSOR']), landTitleController.getLandTitle);
router.get('/attachments/download/:documentId', authenticateToken, requireRole(['ADMIN', 'CASHIER', 'LAND_TITLE_PROCESSOR']), landTitleController.downloadAttachment);
