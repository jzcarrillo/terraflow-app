...
echo -e "\033[0;36m=== Edit Payment Test ===\033[0m"
...
echo -e "\n\033[0;33mEditing payment ID: $PAYMENT_ID\033[0m"
echo -e "\033[0;90mUpdated Data:\033[0m"
echo -e "\033[0;37m$EDIT_DATA\033[0m"

RESPONSE=$(curl -s -X PUT "$API_GATEWAY_URL/api/payments/$PAYMENT_ID" \
    -H "Authorization: Bearer $TOKEN" \
    -H "Content-Type: application/json" \
    -d "$EDIT_DATA")

if [ $? -eq 0 ]; then
    echo -e "\033[0;32mSuccess: Payment updated\033[0m"
    echo "$RESPONSE" | jq -r '"Message: \(.message)\nTransaction ID: \(.transaction_id)"'
else
    echo -e "\033[0;31mFailed\033[0m"
fi

echo -e "\n\033[0;36m=== Edit Payment Completed ===\033[0m"
