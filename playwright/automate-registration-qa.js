...
async function automateLandRegistration() {
  ...
  try {
    ...
    await page.goto('http://localhost:30082/register', { waitUntil: 'networkidle' });
    ...
    await page.goto('http://localhost:30082/login', { waitUntil: 'networkidle' });
    await page.waitForTimeout(2000);
    ...
    if (!paymentTabFound) {
      ...
      await page.goto('http://localhost:30082/payments', { waitUntil: 'networkidle' });
    }
